...
import {addItem} from '../redux/product-modal/shopping-cart/cartItemsSlide'
    ...
    <div className="product">
        <div className="product__images">
            ...
            <div className="product__images__main">
                <img src={(previewImg=== undefined)? product.image01 : previewImg} alt =''/>
            </div>
            ...
            <div className="product__info__item">
                ...
                <div className="product__info__item__list">
                    {product.colors.map((item,index) => (
                        <div onClick={()=> setColor(item)} key={index} className={`product__info__item__list__item ${color === item ? 'active' : ''}` }>
                            <div className={`circle bg-${item}`} alt={`circle bg-${item}`}></div>
                        </div>
                    ))
                    }
                </div>
            ...
            <div className="product__info__item">
                ...
                <div className="product__info__item__list">
                    {product.size.map((item,index) => (
                        <div onClick={()=> setSize(item)} key={index} className={`product__info__item__list__item ${size     === item ? 'active' : ''}`}>
